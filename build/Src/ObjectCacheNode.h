...
{
public:
    XLUA_INLINE FObjectCacheNode(const void* TypeId_) : TypeId(TypeId_), Next(nullptr)
    {
    }

    XLUA_INLINE FObjectCacheNode(const void* TypeId_, FObjectCacheNode* Next_) : TypeId(TypeId_), Next(Next_)
    {
    }

    XLUA_INLINE FObjectCacheNode(FObjectCacheNode&& other) noexcept
    ...
    XLUA_INLINE FObjectCacheNode& operator=(FObjectCacheNode&& rhs) noexcept
    {
        TypeId = rhs.TypeId;
        Next = rhs.Next;
    ...
    XLUA_INLINE FObjectCacheNode* Find(const void* TypeId_)
    {
        if (TypeId_ == TypeId)
        {
            return this;
    ...
    XLUA_INLINE FObjectCacheNode* Add(const void* TypeId_)
    {
