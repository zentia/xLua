...
bool w_]], wrapperInfo.Signature, [[(struct pesapi_ffi* apis, void* methodPointer, pesapi_callback_info info, pesapi_env env, void* self, bool checkLuaArgument, WrapData* wrapData) {
