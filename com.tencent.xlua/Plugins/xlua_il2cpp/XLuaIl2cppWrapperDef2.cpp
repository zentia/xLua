...
// Void CreateRendererResource(Int32, Int32, Boolean) declare in CriWare.CriMana.Player
...
// Void OnPartChange(Protobuf.PartOperate, Int32, OSProto.ActorLevelUpReason) declare in BindableDict`2[OSProto.ActorLevelUpReason,OSProto.SyncProject8ActorExtraData+LevelSourceMap]
...
// Void SimpleSetDataWithConfigID(Int32, UInt32, stFacade, Boolean, Boolean, OSProto.SyncDynamicDesc, System.Object[], Boolean, Boolean) declare in Assets.Scripts.UI.CardComponent.Item.UICardItem
bool w_vti4u4S_u4u4u4i4_DbDbDoDoDbDb(struct pesapi_ffi* apis, MethodInfo* method, Il2CppMethodPointer methodPointer, pesapi_callback_info info, pesapi_env env, void* self, bool checkLuaArgument, WrapData* wrapData) {
    // PLog("Running w_vti4u4S_u4u4u4i4_DbDbDoDoDbDb");
    auto TIp2 = wrapData->TypeInfos[0];
    auto TIp5 = wrapData->TypeInfos[1];
    ...
    int _sv8 = apis->get_arg(info, 8);
    if (true) {
        if (lua_args_len < 3 || lua_args_len > 9) 
            return false;
        ...
        if (lua_args_len > 7 && !converter::Converter<bool>::accept(apis, env, _sv7))
            return false;
        if (lua_args_len > 8 && !converter::Converter<bool>::accept(apis, env, _sv8))
            return false;        
    }
    ...
    Il2CppObject* p6 = OptionalParameter<Il2CppObject*>::GetRefType(apis, env, info, method, wrapData, lua_args_len, 6, TIp6); // LuaValToCSVal primitive with default
    bool p7 = OptionalParameter<bool>::GetPrimitive(apis, env, info, method, wrapData, lua_args_len, 7);
             // LuaValToCSVal primitive with default
    bool p8 = OptionalParameter<bool>::GetPrimitive(apis, env, info, method, wrapData, lua_args_len, 8);
            
    typedef void (*FuncToCall)(void*,int32_t p1, uint32_t p2, struct S_u4u4u4i4_ p3, bool p4, bool p5, Il2CppObject* p6, Il2CppObject* p7, bool p8, bool p9, const void* method);
    ((FuncToCall)methodPointer)(self, p0, p1, p2, p3, p4, p5, p6, p7, p8,  method);
    return true;
}
...
// Void PlayNewCard(OSProto.InteractiveEffectInfo, RectRtRecord ByRef, System.Action) declare in Assets.Scripts.UI.CardComponent.Item.UICardItem
bool w_vtoPS_S_r4r4r4_S_r4r4r4_S_r4r4r4_r4_o(struct pesapi_ffi* apis, MethodInfo* method, Il2CppMethodPointer methodPointer, pesapi_callback_info info, pesapi_env env, void* self, bool checkLuaArgument, WrapData* wrapData) {
    // PLog("Running w_vtoPS_S_r4r4r4_S_r4r4r4_S_r4r4r4_r4_o");
    AutoValueScope value_scope(apis, env);
    auto TIp0 = wrapData->TypeInfos[0];
    auto TIp1 = wrapData->TypeInfos[1];
    auto TIp2 = wrapData->TypeInfos[2];
    ...
    typedef void (*FuncToCall)(void*,Il2CppObject* p1, struct S_S_r4r4r4_S_r4r4r4_S_r4r4r4_r4_* p2, Il2CppObject* p3, const void* method);
    ((FuncToCall)methodPointer)(self, p0, p1, p2,  method);                
    int ret1;
    if (p1 == &up1)
    {
...
bool w_vtpi4i4p(struct pesapi_ffi* apis, MethodInfo* method, Il2CppMethodPointer methodPointer, pesapi_callback_info info, pesapi_env env, void* self, bool checkLuaArgument, WrapData* wrapData) {
    ...
    // LuaValToCSVal P any
    void* p3 = DataTransfer::GetPointer(apis, env, _sv3);
...
// Void SetBothAnchorX(UnityEngine.RectTransform, Single) declare in ExtRectTransform
