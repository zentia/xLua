...
namespace xlua
{
static bool ifg_S__(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);
    auto _src = (S__*)GetValueTypeFieldPtr(nullptr, fieldInfo, offset);

    apis->add_return(info, DataTransfer::CopyValueType<S__>(apis, env, *_src, TIret));            
    return true;
}

static bool ifs_S__(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
...
static bool ifg_i1(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);        
    int8_t ret;
    GetFieldValue(nullptr, fieldInfo, offset, &ret);
...
static bool ifs_i1(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
    pesapi_env env = apis->get_env(info);    // LuaValToCSVal P any
...
static bool ifg_i2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);        
    int16_t ret;
    GetFieldValue(nullptr, fieldInfo, offset, &ret);
...
static bool ifs_i2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
    pesapi_env env = apis->get_env(info);    // LuaValToCSVal P any
...
static bool ifg_tS__(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);
    ...
    auto _src = (S__*)((char*)self + offset);

    apis->add_return(info, DataTransfer::CopyValueType<S__>(apis, env, *_src, TIret));            
    return true;
}

static bool ifs_tS__(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
    pesapi_env env = apis->get_env(info);
    pesapi_value luaThis = apis->get_holder(info);
    auto self = apis->get_native_object_ptr(env, luaThis);
...
static bool ifg_tc(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);
    pesapi_value luaThis = apis->get_holder(info);
    auto self = apis->get_native_object_ptr(env, luaThis);
...
static bool ifs_tc(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
    pesapi_env env = apis->get_env(info);
    pesapi_value luaThis = apis->get_holder(info);
    auto self = apis->get_native_object_ptr(env, luaThis);
...
static bool ifg_ti2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);
    pesapi_value luaThis = apis->get_holder(info);
    auto self = apis->get_native_object_ptr(env, luaThis);
...
static bool ifs_ti2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
    pesapi_env env = apis->get_env(info);
    pesapi_value luaThis = apis->get_holder(info);
    auto self = apis->get_native_object_ptr(env, luaThis);
...
static bool ifg_tu2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);
    pesapi_value luaThis = apis->get_holder(info);
    auto self = apis->get_native_object_ptr(env, luaThis);
...
static bool ifs_tu2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
    pesapi_env env = apis->get_env(info);
    pesapi_value luaThis = apis->get_holder(info);
    auto self = apis->get_native_object_ptr(env, luaThis);
...
static bool ifg_u2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIret) 
{
    pesapi_env env = apis->get_env(info);        
    uint16_t ret;
    GetFieldValue(nullptr, fieldInfo, offset, &ret);
...
static bool ifs_u2(pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* fieldInfo, size_t offset, Il2CppClass* TIp) 
{
    pesapi_env env = apis->get_env(info);    // LuaValToCSVal P any
    uint16_t p = converter::Converter<uint16_t>::toCpp(apis, env, apis->get_arg(info, 0));
