...
static pesapi_func_ptr funcs[] = {(pesapi_func_ptr) &pesapi_create_null, (pesapi_func_ptr) &pesapi_create_undefined,
    ...
    (pesapi_func_ptr) &pesapi_get_env_from_ref, (pesapi_func_ptr) &pesapi_env_ref_is_valid,
    ...
    (pesapi_func_ptr) &pesapi_set_property_uint32, (pesapi_func_ptr) &pesapi_get_private, (pesapi_func_ptr) &pesapi_set_private,
    (pesapi_func_ptr) &pesapi_call_function, (pesapi_func_ptr) &pesapi_dostring, (pesapi_func_ptr) &pesapi_global,
