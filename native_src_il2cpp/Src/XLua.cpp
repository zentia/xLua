...
static const lua_CFunction direct_getters[10] = {xlua_struct_get_int8_t, xlua_struct_get_uint8_t, xlua_struct_get_int16_t,
    xlua_struct_get_uint16_t, xlua_struct_get_int32_t, xlua_struct_get_uint32_t, xlua_struct_get_int64_t, xlua_struct_get_uint64_t,
...
static const lua_CFunction direct_setters[10] = {xlua_struct_set_int8_t, xlua_struct_set_uint8_t, xlua_struct_set_int16_t,
    xlua_struct_set_uint16_t, xlua_struct_set_int32_t, xlua_struct_set_uint32_t, xlua_struct_set_int64_t, xlua_struct_set_uint64_t,
