...
inline static v8::Local<v8::Value> CSRefToLuaValue(lua_State* L, v8::Local<v8::Context> Context, void* Obj)
{
    if (!Obj)
    {
    ...
    pesapi_value luaVal = GUnityExports.TryTranslateBuiltin(*Context, Obj);
...
//type == typeof(object)
inline static v8::Local<v8::Value> CSAnyToLuaValue(lua_State* luaState, v8::Local<v8::Context> Context, void* Obj)
{
...
inline static v8::Local<v8::Value> CopyValueType(lua_State* L, v8::Local<v8::Context> Context, const void* TypeId, const void* Ptr, size_t SizeOfValueType)
{
...
inline static v8::Local<v8::Value> CopyNullableValueType(lua_State* L, v8::Local<v8::Context> Context, const void* TypeId, const void* Ptr, bool hasValue, size_t SizeOfValueType)
{
