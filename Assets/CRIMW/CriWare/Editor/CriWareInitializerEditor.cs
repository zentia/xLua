...
public class CriWareInitializerEditor : UnityEditor.Editor
{
	...
	static private bool showAtomPs5Config               = false;
	...
	/* @cond excludele */
				...
				showAtomPs5Config = EditorGUILayout.Foldout(showAtomPs5Config, "PS5 Config");
				if (showAtomPs5Config) {
					EditorGUI.indentLevel += 1;
					GenIntField("Max Channel Ports", "", ref initializer.atomConfig.ps5PortConfig.maxChannelPorts, 1, 256);
					GenIntField("Max Object Ports", "", ref initializer.atomConfig.ps5PortConfig.maxObjectPorts, 0, 256);
					EditorGUI.indentLevel -= 1;
				}
	...
	/* @cond excludele */
			...
			EditorGUI.indentLevel += 1;
			{
				...
				GenToggleField("Use Streamer Manager", "", ref initializer.manaConfig.useStreamerManager);
	...
	/* @cond excludele */
			...
			if (!string.IsNullOrEmpty(initializer.DecrypterConfig.key)) {
