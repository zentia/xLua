...
namespace CriTimeline.Mana
{
	...
	public class CriManaTimelineComponentEditor : UnityEditor.Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			var duration = (target as CriManaClip)?.m_clip?.duration ?? -1f;
			...
			if (duration >= 0f) {
				...
				EditorGUILayout.PropertyField(m_fadeinDuration, new GUIContent("Duration [sec]"));
			}
			...
			if(duration >= 0f) {
				...
				EditorGUILayout.PropertyField(m_fadeoutDuration, new GUIContent("Duration [sec]"));
			}
