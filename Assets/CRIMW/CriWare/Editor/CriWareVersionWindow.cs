...
public sealed class CriWareVersionWindow : EditorWindow
{
	...
	/* @cond excludele */
		...
		new string[]{"XboxOne", "XboxOne",        "CRI Lips Unity", "GameCoreXboxOne/cri_lips_unity.dll", ""},
		new string[]{"Scarlett", "Scarlett",      "CRI Lips Unity", "Scarlett/cri_lips_unity.dll", ""},
		new string[]{"Scarlett", "Scarlett",      "CRI Lips Unity", "GameCoreScarlett/cri_lips_unity.dll", ""},
	...
	/* @cond excludele */
		...
		new string[]{"XboxOne", "XboxOne",        "CRI Vpx", "GameCoreXboxOne/cri_mana_vpx.dll", ""},
		new string[]{"Scarlett", "Scarlett",      "CRI Vpx", "GameCoreScarlett/cri_mana_vpx.dll", ""}
	/* @endcond */
	};

	private readonly string[][] SoundxrBinaryFilenames = {
	/* @cond excludele */
		new string[]{"PC",      "PCx64",          "CRI Sound xR", "x86_64/criafx_soundxr.dll", ""},
		new string[]{"MacOSX",  "Mac_X86_64",     "CRI Sound xR", "criafx_soundxr_macosx.bundle", "Contents/MacOS/criafx_soundxr_macosx"},
		new string[]{"MacOSX",  "Mac_ARMv8_A64",  "CRI Sound xR", "criafx_soundxr_macosx.bundle", "Contents/MacOS/criafx_soundxr_macosx"},
		new string[]{"Android", "Android",        "CRI Sound xR", "Android/libs/arm64-v8a/libcriafx_soundxr.so", ""},
		new string[]{"Android", "Android",        "CRI Sound xR", "Android/libs/armeabi-v7a/libcriafx_soundxr.so", ""},
		new string[]{"iOS",     "iOS_ARMv8_A64",  "CRI Sound xR", "iOS/libcriafx_soundxr.a", ""},
		new string[]{"PS4",     "PS4",            "CRI Sound xR", "PS4/libcriafx_soundxr.a", ""},
		new string[]{"PS5",     "PS5",            "CRI Sound xR", "PS5/libcriafx_soundxr.a", ""},
		new string[]{"XboxOne", "XboxOne",        "CRI Sound xR", "GameCoreXboxOne/criafx_soundxr.dll", ""},
		new string[]{"Scarlett", "Scarlett",      "CRI Sound xR", "GameCoreScarlett/criafx_soundxr.dll", ""},
		new string[]{"SWITCH",  "SWITCH",         "CRI Sound xR", "NX64/libcriafx_soundxr.a", ""}
	/* @endcond */
	};
	
	private readonly string[][] rtcBinaryFilenames = {
	/* @cond excludele */
		new string[]{"PC",      "PCx64",          "CRI Rtc", "PC/x86_64/cri_rtc_unity.dll", ""},
		new string[]{"MacOSX",  "Mac_X86_64",     "CRI Rtc", "cri_rtc_unity.bundle", "Contents/MacOS/cri_rtc_unity"},
		new string[]{"MacOSX",  "Mac_ARMv8_A64",  "CRI Rtc", "cri_rtc_unity.bundle", "Contents/MacOS/cri_rtc_unity"},
		new string[]{"Android", "Android",        "CRI Rtc", "Android/libs/arm64-v8a/libcri_rtc_unity.so", ""},
		new string[]{"Android", "Android",        "CRI Rtc", "Android/libs/armeabi-v7a/libcri_rtc_unity.so", ""},
		new string[]{"Android", "Android",        "CRI Rtc", "Android/libs/x86/libcri_rtc_unity.so", ""},
		new string[]{"Android", "Android",        "CRI Rtc", "Android/libs/x86_64/libcri_rtc_unity.so", ""},
		new string[]{"iOS",     "iOS_ARMv7",      "CRI Rtc", "iOS/libcri_rtc_unity.a", ""},
		new string[]{"iOS",     "iOS_ARMv7s",     "CRI Rtc", "iOS/libcri_rtc_unity.a", ""},
		new string[]{"iOS",     "iOS_ARMv8_A64",  "CRI Rtc", "iOS/libcri_rtc_unity.a", ""},
		new string[]{"iOS",     "iOS_SIM_X86",    "CRI Rtc", "iOS/libcri_rtc_unity.a", ""},
		new string[]{"iOS",     "iOS_SIM_X86_64", "CRI Rtc", "iOS/libcri_rtc_unity.a", ""},
		new string[]{"tvOS",    "iOS_ARMv8_A64",  "CRI Rtc", "tvOS/libcri_rtc_unity.a", ""},
		new string[]{"tvOS",    "iOS_SIM_X86_64", "CRI Rtc", "tvOS/libcri_rtc_unity.a", ""},
		new string[]{"PS4",     "PS4",            "CRI Rtc", "PS4/cri_rtc_unity.prx", ""},
		new string[]{"PS5",     "PS5",            "CRI Rtc", "PS5/cri_rtc_unity.prx", ""},
		new string[]{"XboxOne", "XboxOne",        "CRI Rtc", "XboxOne/cri_rtc_unity.dll", ""},
		new string[]{"XboxOne", "XboxOne",        "CRI Rtc", "GameCoreXboxOne/cri_rtc_unity.dll", ""},
		new string[]{"Scarlett", "Scarlett",      "CRI Rtc", "Scarlett/cri_rtc_unity.dll", ""},
		new string[]{"Scarlett", "Scarlett",      "CRI Rtc", "GameCoreScarlett/cri_rtc_unity.dll", ""},
		new string[]{"SWITCH",  "SWITCH",         "CRI Rtc", "NX64/cri_rtc_unity.a", ""},
		/* @endcond */
	};
	...
	private Dictionary<PluginType, bool> doesModuleExist = new Dictionary<PluginType, bool> {
		{PluginType.CRIWARE, true},
	...
	private void CheckEachModuleExistence() {
		foreach (PluginType moduleEnum in moduleEnumList) {
			if (moduleEnum != PluginType.CRIWARE) {
				doesModuleExist[moduleEnum] = !string.IsNullOrEmpty(GetScriptVersion(moduleEnum));
			}
		}
	}
	...
	/* @cond excludele */
			currentPluginType = GUIModuleSelector(currentPluginType);
	/* @endcond */
			if (GUI.changed) {
				selectedInfoIndex = 0;
