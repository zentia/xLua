...
namespace CriMana.Detail
{
	...
	#error unsupported platform
		...
		{
			// Note: This renderer use a deprecated API: CRIWARE027BD134.
			// Todo: use CRIWAREF2D114CF with a c++ rendereDecoder class if needed.
			bool isFrameUpdated = CRIWARE027BD134(
				playerId,
		...
		private static extern bool CRIWARE027BD134(
			int player_id,
