...
namespace CriMana.Detail
{
	public abstract class RendererResource : System.IDisposable
	{
		...
		{
			return CRIWAREF09E6C21(playerId);
		}
		...
		public virtual int GetDisplayedFrameNo() { return -1; }
		...
		protected static extern bool CRIWAREF86A01CB(
			int player_id,
			int num_textures,
		...
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		protected static extern bool CRIWAREF2D114CF(
			int player_id,
			int num_textures,
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWAREC1A9393E(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWARE58525AB9(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern sbyte CRIWAREF09E6C21(
            int player_id
        );
		#else
		protected static bool CRIWAREF86A01CB(
			int player_id,
			int num_textures,
			System.IntPtr[] tex_ptrs,
			[In, Out] FrameInfo frame_info,
		...
		protected static bool CRIWAREF2D114CF(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWAREC1A9393E(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWARE58525AB9(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

        protected static sbyte CRIWAREF09E6C21(
            int player_id
        ) { return 0; }
		#endif
		#endregion
