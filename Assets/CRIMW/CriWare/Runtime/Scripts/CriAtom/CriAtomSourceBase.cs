...
namespace CriWare {
	/**
	 * <summary>Base class of the component for audio playback</summary>
	 * <remarks>
	 * <para header='Description'>Base class for playback components. <br/>
	 * By inheriting this class, it is possible to customize the components used for audio playback.<br/></para>
	 * </remarks>
	 */
	public abstract class CriAtomSourceBase : CriMonoBehaviour
	{
		...
		*/
		 ...
		 * \deprecated
		 * This is a deprecated API that will be removed.
		 * Please consider using CriAtomSourceBase.SetAisacControl instead.
		*/
