...
public partial class CriAtomExAsrRack : CriDisposable
{
	...
	*/
	...
	{
	#if CRIWARE_SUPPORT_ASR
		this._rackId = CRIWARE371E126C(ref config, ref platformConfig);
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern Int32 CRIWARE371E126C([In] ref Config config, [In] ref PlatformConfig platformConfig);
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE6057F03E(ref Config config);
	...
	private static Int32 CRIWARE371E126C([In] ref Config config, [In] ref PlatformConfig platformConfig) { return 0; }
	...
	private static void CRIWARE6057F03E(ref Config config) { }
	#endif
