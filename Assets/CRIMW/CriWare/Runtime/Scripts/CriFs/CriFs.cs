...
/**
 * <summary>Global class of the Fs library</summary>
 */
public class CriFs
{
	/**
	 * <summary>Get the number of binders used</summary>
	 * <param name='curNum'>The number of binders in use</param>
	 * <param name='maxNum'>Maximum number of binders used simultaneously</param>
	 * <param name='limit'>Maximum number of usable binders</param>
	 * <returns>Whether the acquisition succeeded</returns>
	 * <remarks>
	 * <para header='Description'>Return the number of binders being used.<br/>
	 * <br/></para>
	 * </remarks>
	 */
	public static bool GetNumUsedBinders(out int curNum, out int maxNum, out int limit)
	{
		...
		return 0 == NativeMethods.criFs_GetNumUsedBinders(ref curNum, ref maxNum, ref limit);
	}

	/**
	 * <summary>Get the number of loaders used</summary>
	 * <param name='curNum'>The number of loaders in use</param>
	 * <param name='maxNum'>Maximum number of loaders used simultaneously</param>
	 * <param name='limit'>Maximum number of usable loaders</param>
	 * <returns>Whether the acquisition succeeded</returns>
	 * <remarks>
	 * <para header='Description'>Get the numbers of loaders used <br/></para>
	 * </remarks>
	 */
	public static bool GetNumUsedLoaders(out int curNum, out int maxNum, out int limit)
	{
		curNum = maxNum = limit = 0;
		return 0 == NativeMethods.criFs_GetNumUsedLoaders(ref curNum, ref maxNum, ref limit);
	}

	/**
	 * <summary>Get the number of installers used</summary>
	 * <param name='curNum'>The number of installers in use</param>
	 * <param name='maxNum'>Maximum number of installers used simultaneously</param>
	 * <param name='limit'>Maximum number of usable installers</param>
	 * <returns>Whether the acquisition succeeded</returns>
	 * <remarks>
	 * <para header='Description'>Get the number of installers being used.<br/>
	 * <br/></para>
	 * </remarks>
	 */
	...
	{
		curNum = maxNum = limit = 0;
		return 0 == NativeMethods.criFs_GetNumUsedInstallers(ref curNum, ref maxNum, ref limit);
	}

	/**
	 * <summary>Get the number of bindings</summary>
	 * <param name='curNum'>Number of files currently bound</param>
	 * <param name='maxNum'>Maximum number of simultaneous bindings</param>
	 * <param name='limit'>Maximum number of bindings</param>
	 * <returns>Whether the acquisition succeeded</returns>
	 * <remarks>
	 * <para header='Description'>Return the number of bindings.<br/>
	 * <br/></para>
	 * </remarks>
	 */
	...
	{
		curNum = maxNum = limit = 0;
		return 0 == NativeMethods.criFs_GetNumBinds(ref curNum, ref maxNum, ref limit);
	}

	/**
	 * <summary>Get the number of opened files</summary>
	 * <param name='curNum'>Number of files currently open</param>
	 * <param name='maxNum'>Maximum number of files opened simultaneously</param>
	 * <param name='limit'>Maximum number of files that can be opened simultaneously</param>
	 * <returns>Whether the acquisition succeeded</returns>
	 * <remarks>
	 * <para header='Description'>Return the number of opened files.<br/>
	 * <br/></para>
	 * </remarks>
	 */
	...
	{
		curNum = maxNum = limit = 0;
		return 0 == NativeMethods.criFs_GetNumOpenedFiles(ref curNum, ref maxNum, ref limit);
	}
	...
	class NativeMethods
	{
		...
		internal static extern Int32 criFs_GetNumUsedBinders(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		internal static extern Int32 criFs_GetNumUsedLoaders(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		internal static extern Int32 criFs_GetNumUsedGroupLoaders(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		internal static extern Int32 criFs_GetNumUsedStdioHandles(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		internal static extern Int32 criFs_GetNumUsedInstallers(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		internal static extern Int32 criFs_GetNumBinds(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		internal static extern Int32 criFs_GetNumOpenedFiles(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit);
#else
		internal static Int32 criFs_GetNumUsedBinders(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit) { return default(Int32); }
		internal static Int32 criFs_GetNumUsedLoaders(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit) { return default(Int32); }
		internal static Int32 criFs_GetNumUsedGroupLoaders(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit) { return default(Int32); }
		internal static Int32 criFs_GetNumUsedStdioHandles(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit) { return default(Int32); }
		internal static Int32 criFs_GetNumUsedInstallers(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit) { return default(Int32); }
		internal static Int32 criFs_GetNumBinds(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit) { return default(Int32); }
		internal static Int32 criFs_GetNumOpenedFiles(ref Int32 curNum, ref Int32 maxNum, ref Int32 limit) { return default(Int32); }
#endif
	}
}
...
public class CriFsBinder : CriDisposable
{
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWAREB4C95FED(uint id);
	...
	private static int CRIWAREB4C95FED(uint id) { return 0; }
	#endif
...
public static class CriFsUtility
{
	 ...
	 * <remarks>
	 * <para header='Description'>Begin installing the files.<br/>
	 * Specify the source file path (URL) in srcPath and the destination file path in dstPath.<br/>
	 * <br/>
	 * This function is asynchronous.<br/>
	 * Check CriWare.CriFsWebInstallRequest::isDone to confirm whether the installation is completed or not.<br/>
	 * If an error occurs during the installation process, the error information will be stored in CriWare.CriFsWebInstallRequest::error .<br/>
	 * <br/>
	 * This method may cause an exception when accessing files internally.<br/>
	 * We recommend encapsulating the call in a try-catch statement to handle request failures.<br/></para>
	...
	{
		/* User-Agent文字列を指定 */
		CRIWARE204D804B(userAgentString);
	}
	...
	{
		/* プロキシ設定 */
		CRIWARE7E034A00(proxyPath, proxyPort);
	}
	...
	{
		CRIWAREE50FC238(filter);
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE204D804B(string userAgentString);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE7E034A00(string proxyPath, UInt16 proxyPort);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWAREE50FC238(string filter);
	#else
	private static bool CRIWARE204D804B(string userAgentString) { return true; }
	private static bool CRIWARE7E034A00(string proxyPath, UInt16 proxyPort) { return true; }
	private static bool CRIWAREE50FC238(string filter) {return true; }
	#endif
	#endregion
}
...
public static class CriFsPlugin
{
	...
	private static int numAdditionalLoaders = 0;
#endif
	...
	{
#if UNITY_EDITOR && UNITY_WEBGL
		num_loaders += numAdditionalLoaders;
#endif
		CriFsPlugin.CRIWARE6BF1525B(
	...
	{
#if UNITY_EDITOR && UNITY_WEBGL
		numAdditionalLoaders = additionalLoaders;
#endif
	}
	...
	public static void InitializeLibrary()
	{
...
#if !UNITY_EDITOR && UNITY_PS5
		{
			...
			var ps5FsFlag = true;
#endif
			CriWarePS5.SetupFileSystem(ps5FsFlag);
		}
#endif

		/* ライブラリの初期化 */
		CriFsPlugin.CRIWARE79142260();
	}

	public static bool IsLibraryInitialized()
	{
		/* ライブラリが初期化済みかチェック */
		return CRIWARE7FE43E9C();
	}
	...
	public static void FinalizeLibrary()
	{
		...
		/* ライブラリの終了 */
		CriFsPlugin.CRIWARE191050E8();
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE6BF1525B(
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE79142260();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE7FE43E9C();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE191050E8();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWAREF892BA1B();
	...
	private static void CRIWARE6BF1525B(
		int num_loaders, int num_binders, int num_installers, int max_path, bool minimize_file_descriptor_usage, bool enable_crc_check) { }
	private static void CRIWARE79142260() { _dummyInitialized = true; }
	public static bool CRIWARE7FE43E9C() { return _dummyInitialized; }
	private static void CRIWARE191050E8() { _dummyInitialized = false; }
	public static uint CRIWAREF892BA1B() { return 0u; }
