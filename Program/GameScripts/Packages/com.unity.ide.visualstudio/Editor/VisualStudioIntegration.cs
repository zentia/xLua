...
namespace Microsoft.Unity.VisualStudio.Editor
{
	...
	internal class VisualStudioIntegration
	{
		...
		{
            // VisualStudioIntegration may cause performance issuse
            return;
		...
		private static void Refresh()
		{
            ...
            bool isLegacyAutoRefreshOpen = EditorPrefs.GetBool("kAutoRefresh");
            // 0 : AssetPipelineAutoRefreshMode.Disabled
            // 1 : AssetPipelineAutoRefreshMode.Enabled
            // 2 : AssetPipelineAutoRefreshMode.EnabledOutsidePlaymode
            bool isAutoRefreshOpen = EditorPrefs.GetInt("kAutoRefreshMode", isLegacyAutoRefreshOpen ? 1 : 0) == 1;
            if (!isAutoRefreshOpen)
                return;
