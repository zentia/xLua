...
namespace Microsoft.Unity.VisualStudio.Editor
{
	...
	public class AssemblyNameProvider : IAssemblyNameProvider
	{
		...
		protected ProjectGenerationFlag m_ProjectGenerationFlag = (ProjectGenerationFlag)EditorPrefs.GetInt(
		...
		public virtual IEnumerable<Assembly> GetAssemblies(Func<string, bool> shouldFileBePartOfSolution)
		{
