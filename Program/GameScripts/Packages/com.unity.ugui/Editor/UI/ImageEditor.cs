...
namespace UnityEditor.UI
{
    ...
    public class ImageEditor : GraphicEditor
    {
        ...
        protected Action<bool, Sprite> m_SpriteGUIExt;
        ...
        protected void SpriteGUI()
        {
...
#if OSGAME
            using (new EditorGUI.DisabledScope(!image.isSpriteEditable))
#endif
            {
            ...
            if (spriteChanged)
            {
                ...
                m_SpriteGUIExt?.Invoke(true, newSprite);
            }
            else
            {
                m_SpriteGUIExt?.Invoke(false, null);
