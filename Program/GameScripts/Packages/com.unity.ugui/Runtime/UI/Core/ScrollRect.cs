...
namespace UnityEngine.UI
{
    ...
    public class ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        {
            Int32 sampleIndex = -1;
            UGUIStats.BeginSample(UGUIStatsSampleId.UGUI,"ScrollRect.Rebuild", ref sampleIndex);
        ...
        private void EnsureLayoutHasRebuilt()
        {
            ...
            {
                Int32 sampleIndex = -1;
                UGUIStats.BeginSample(UGUIStatsSampleId.UGUI,"EnsureLayoutHasRebuilt.ForceUpdateCanvases", ref sampleIndex);
        ...
        protected virtual void FixDragDelta(ref Vector2 pointerDelta)
        {
        }
