...
namespace UnityEngine.UI
{
    ...
    public class GraphicRegistry
    {
        ...
        public static List<Canvas> GetAllRegisteredeGraphicsCanvas() 
        {
            List<Canvas> canvasList = new List<Canvas>();
            var itr = instance.m_Graphics.GetEnumerator();
            while(itr.MoveNext()) 
            {
                canvasList.Add(itr.Current.Key);
            }
            return canvasList;
        }

        public static List<Canvas> GetAllRegisteredRaycastableGraphicsCanvas() 
        {
            List<Canvas> canvasList = new List<Canvas>();
            var itr = instance.m_RaycastableGraphics.GetEnumerator();
            while(itr.MoveNext()) 
            {
                canvasList.Add(itr.Current.Key);
            }
