...
namespace UnityEngine.UI
{
    ...
    public class InputField
        ...
        ILayoutElement
    {
        public static HashSet<char> emojiHashSet = new();
        /// <summary>
        ...
        public bool UpdateDrag => m_UpdateDrag;
        ...
        private static bool IsOpenHarmony()
        {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_Text != val)
            {
                ...
                else
                {
                    ...
                    if (m_Keyboard.canGetSelection && !IsOpenHarmony())
                    {
            ...
            else if (m_Keyboard.canGetSelection && !m_HideMobileInput  && !IsOpenHarmony())
            {
                UpdateCaretFromKeyboard();
            }
        ...
        protected virtual void Append(char input)
        {
            ...
            if (!InPlaceEditing())
                return;
            if (emojiHashSet.Contains(input))
            {
                return;
            }
        ...
        protected void UpdateLabel()
        {
            if (m_TextComponent != null && m_TextComponent.font != null && !m_PreventFontCallback)
            {
                ...
                if (!isEmpty)
                {
                    ...
                    m_TextComponent.GetGenerationSettings(extents, ref settings);
                    settings.generateOutOfBounds = true;

                    cachedInputTextGenerator.PopulateWithErrors(processed, ref settings, gameObject);
        ...
        {
            Int32 sampleIndex = -1;
            UGUIStats.BeginSample(UGUIStatsSampleId.UGUI, "InputField.Rebuild", ref sampleIndex);
            switch (update)
            {
        ...
        public virtual float preferredWidth
        {
            get
            {
                if (textComponent == null)
                    return 0;
                TextGenerationSettings settings = new TextGenerationSettings();
                textComponent.GetGenerationSettings(Vector2.zero, ref settings);
                return textComponent.cachedTextGeneratorForLayout.GetPreferredWidth(m_Text, ref settings) / textComponent.pixelsPerUnit;
            }
        }
        ...
        public virtual float preferredHeight
        {
            get
            {
                if (textComponent == null)
                    return 0;
                TextGenerationSettings settings = new TextGenerationSettings();
                textComponent.GetGenerationSettings(new Vector2(textComponent.rectTransform.rect.size.x, 0.0f), ref settings);
                return textComponent.cachedTextGeneratorForLayout.GetPreferredHeight(m_Text, ref settings) / textComponent.pixelsPerUnit;
            }
        }
