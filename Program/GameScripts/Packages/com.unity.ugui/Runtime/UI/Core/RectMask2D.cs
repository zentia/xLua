...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public class RectMask2D : UIBehaviour, IClipper, ICanvasRaycastFilter, IPrefabVisibleObserver
    {
        [NonSerialized]
        ...
        private IPrefabVisibleObserver _prefabVisibleObserverImplementation;
        ...
        public virtual void PerformClipping()
        {
            ...
            //Debug.LogFormat(LogType.Log, LogOption.NoStacktrace, this.gameObject, "RectMask2D.PerformClipping: {0}", this.gameObject.name);

            Int32 sampleIndex = -1;
            UGUIStats.BeginSample(UGUIStatsSampleId.UGUI,"PerformClipping", ref sampleIndex);
        ...
        public void OnPrefab2DVisibleChg(Boolean visible, int activeMask)
        {
            if (visible)
            {
