...
namespace UnityEngine.UI
{
    ...
    public abstract class LayoutGroup : UIBehaviour, ILayoutElement, ILayoutGroup
    {
        ...
        /// </remarks>
        public TextAnchor childAlignment { get { return m_ChildAlignment; }
            set
            {
                if (m_ChildAlignment != value)
                {
        ...
        protected void SetChildAlongAxisWithScale(RectTransform rect, int axis, float pos, float size, float scaleFactor)
        {
            ...
            rect.anchorMin = axis == 0 ? Vector2.zero : Vector2.up;
            rect.anchorMax = axis == 0 ? Vector2.zero : Vector2.up;
