...
namespace UnityEngine.UI
{
    ...
    public class LayoutRebuilder : ICanvasElement
    {
        ...
        public Int32 GetStatsNameId()
        {
            ...
            if(m_StatsNameId == -1)
            {
                var canvas = Graphic.FindCanvas(transform.gameObject);
                var profileName = $"{canvas?.name ??  "<null>"}##{transform.gameObject.name}";
        ...
        {
            Int32 sampleIndex = -1;
            UGUIStats.BeginSample(UGUIStatsSampleId.UGUI,"LayoutRebuilder.Rebuild", ref sampleIndex);
            switch (executing)
            {
        ...
        private void PerformLayoutControl(RectTransform rect, UnityAction<Component> action)
        {
            ...
            Int32 sampleIndex = -1;
            UGUIStats.BeginSample(UGUIStatsSampleId.UGUI,"LayoutRebuilder.PerformLayoutControl", ref sampleIndex);
        ...
        private void PerformLayoutCalculation(RectTransform rect, UnityAction<Component> action)
        {
            ...
            Int32 sampleIndex = -1;
            UGUIStats.BeginSample(UGUIStatsSampleId.UGUI,"LayoutRebuilder.PerformLayoutCalculation", ref sampleIndex);
            var components = ListPool<Component>.Get();
        ...
        public static void MarkLayoutForRebuild(RectTransform rect)
        {
            ...
            // UnityEngine.Profiling.Profiler.BeginSample("LayoutRebuildder.MarkLayoutForRebuild");
            // UnityEngine.Profiling.Profiler.BeginSample("MarkLayoutForRebuild.Part1");
            var comps = ListPool<Component>.Get();
            RectTransform layoutRoot = GetLayoutRoot(rect, comps);
        ...
        public static RectTransform GetLayoutRoot(RectTransform rect)
        {
            var comps = ListPool<Component>.Get();
            var layoutRoot = GetLayoutRoot(rect, comps);
            ListPool<Component>.Release(comps);
            return layoutRoot;
        }

        private static RectTransform GetLayoutRoot(RectTransform rect, List<Component> comps)
        {
        ...
        private static void MarkLayoutRootForRebuild(RectTransform controller)
        {
            ...
            // UnityEngine.Profiling.Profiler.BeginSample("LayoutRebuildder.MarkLayoutRootForRebuild");
            var rebuilder = s_Rebuilders.Get();
