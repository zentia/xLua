...
namespace UnityEngine.EventSystems
{
    ...
    public abstract class UIBehaviour : MonoBehaviour
    {
        ...
        private string m_ProfilerName;
        protected string ProfilerName
        {
            get
            {
                if (m_ProfilerName == null)
                    m_ProfilerName = name;
                return m_ProfilerName;
            }
        }
#endif
        [NonSerialized] protected RectTransform m_RectTransform;
        /// <summary>
        /// Transform gets cached for speed.
        /// </summary>
        public RectTransform rectTransform
        {
            get { return m_RectTransform ?? (m_RectTransform = transform as RectTransform); }
        }
